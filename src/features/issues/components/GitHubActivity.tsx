    ...
    <div className="space-y-4">
      ...
      {pullRequests.length > 0 && (
        <div className="space-y-2">
          <p className="text-xs font-medium text-muted-foreground uppercase">Pull Requests</p>
          {pullRequests.map((pr) => (
            <a
              key={pr.id}
              href={pr.pr_url}
              ...
              className="flex items-center gap-2 p-2 bg-muted/50 rounded-md hover:bg-muted transition-colors group"
            >
      ...
      {commits.length > 0 && (
        <div className="space-y-2">
          <p className="text-xs font-medium text-muted-foreground uppercase">Commits</p>
